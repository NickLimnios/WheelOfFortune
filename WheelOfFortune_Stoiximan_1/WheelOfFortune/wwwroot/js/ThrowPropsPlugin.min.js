...
(window._gsQueue || (window._gsQueue = [])).push(function () {
    ...
    window._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function (t, e, i, r) {
        var s, n, a, o, l = function () {
            ...
            return s > i ? s = i : r > s && (s = r), {max: s, min: s}
            ...
            var h, p, _, m, g, v, y, w, x, T, b = 0, P = 9999999999, k = s.throwProps || s,
        ...
        return g.constructor = l, l.version = "0.9.2", l.source = "gannon.codecanyon", l.API = 2, l._autoCSS = !0, l.defaultResistance = 100, l.track = function (t, e, i) {
            ...
            i.throwProps || (i = {throwProps: i}), 0 === h && (i.throwProps.preventOvershoot = !0);
            var u = new e(t, 1, i);
            ...
            var s, n, l, h, u, p, _, d, m, g = i._ease, v = isNaN(e.checkpoint) ? .05 : Number(e.checkpoint),
                y = i._duration, w = e.preventOvershoot, x = 0;
            for (s in e) if ("resistance" !== s && "checkpoint" !== s && "preventOvershoot" !== s) {
                if (n = e[s], "number" == typeof n) u = Number(n) || 0; else if ("object" != typeof n || isNaN(n.velocity)) {
        ...
        return d.addProp = function (e, i) {
            if (!this._lookup[e]) {
                var r = this.target, s = "function" == typeof r[e], n = s ? this._altProp(e) : e, a = this._firstVP;
                this._firstVP = this._lookup[e] = this._lookup[n] = a = new p(n !== e && 0 === e.indexOf("set") ? n : e, s, a), a.css = this.elem && (void 0 !== this.target.style[a.p] || o[a.p]), a.css && o[a.p] && !r._gsTransform && t.set(r, {x: "+=0"}), a.type = i || a.css && 0 === e.indexOf("rotation") ? "deg" : "", a.v1 = a.v2 = a.css ? h(r, a.p) : s ? r[a.p]() : r[a.p]
            }
            ...
            var e, i, r, s = this._lookup[t], n = this.target;
